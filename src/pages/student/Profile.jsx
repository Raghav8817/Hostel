...
const Profile = () => {
    ...
    const handleApplyRoom = async () => {
        ...
        try {
            ...
            if (res.ok) {
                setApplyStatus("Applied successfully! Awaiting admin approval.");
                setSelectedRoom("");
                fetchRoomData();
            } else {
                ...
                <div className="profile-left-col">
                    <div className="profile-card">
                        ...
                        <div className="profile-info">
                            ...
                            <p style={{ justifyContent: "center" }}><strong>Role:</strong> {user.role || 'Student'}</p>
